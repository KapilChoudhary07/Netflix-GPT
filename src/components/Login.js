  ...
  return (
    <div>
      ...
      <form
        ...
        className="w-[90%] sm:w-[60%] md:w-5/12 lg:w-3/12 absolute p-6 sm:p-8 bg-black my-20 sm:my-28 md:my-36 mx-auto right-0 left-0 text-white rounded-lg bg-opacity-90"
      >
